/**
  ...
  ******************************************************************************
  */
#ifndef AI_MNISTCNN_H
#define AI_MNISTCNN_H

#include "mnistcnn_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_MNISTCNN_MODEL_NAME          "mnistcnn"
#define AI_MNISTCNN_ORIGIN_MODEL_NAME   "mnist_nn_c2_16_10"

/******************************************************************************/
#define AI_MNISTCNN_ACTIVATIONS_ALIGNMENT   (4)
#define AI_MNISTCNN_INPUTS_IN_ACTIVATIONS   (4)
#define AI_MNISTCNN_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MNISTCNN_IN_NUM        (1)

AI_DEPRECATED
#define AI_MNISTCNN_IN \
  ai_mnistcnn_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MNISTCNN_IN_SIZE { \
  AI_MNISTCNN_IN_1_SIZE, \
}
#define AI_MNISTCNN_IN_SIZE_BYTES { \
  AI_MNISTCNN_IN_1_SIZE_BYTES, \
}
#define AI_MNISTCNN_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MNISTCNN_IN_1_HEIGHT      (28)
#define AI_MNISTCNN_IN_1_WIDTH       (28)
#define AI_MNISTCNN_IN_1_CHANNEL     (1)
#define AI_MNISTCNN_IN_1_SIZE        (784)
#define AI_MNISTCNN_IN_1_SIZE_BYTES  (3136)

/******************************************************************************/
#define AI_MNISTCNN_OUT_NUM       (1)

AI_DEPRECATED
#define AI_MNISTCNN_OUT \
  ai_mnistcnn_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MNISTCNN_OUT_SIZE { \
  AI_MNISTCNN_OUT_1_SIZE, \
}
#define AI_MNISTCNN_OUT_SIZE_BYTES { \
  AI_MNISTCNN_OUT_1_SIZE_BYTES, \
}
#define AI_MNISTCNN_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MNISTCNN_OUT_1_CHANNEL     (10)
#define AI_MNISTCNN_OUT_1_SIZE        (10)
#define AI_MNISTCNN_OUT_1_SIZE_BYTES  (40)

/******************************************************************************/
#define AI_MNISTCNN_N_NODES (5)
 ...
 * @ref ai_mnistcnn_create. Both the activations memory buffer 
 ...
 * using @ref ai_mnistcnn_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_mnistcnn_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_mnistcnn_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_MNISTCNN_*
 * defines into file @ref mnistcnn.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
